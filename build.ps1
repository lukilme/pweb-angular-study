...
Write-Host "Diretório atual: $diretorioAtual"
...
if ($resposta -eq "y") {
    ...
    $sourceFolder = "C:\Users\Desktop\Desktop\lukilme\college\pweb-angular\dist\pweb-angular\browser"
    $destinationFolder = "C:\Users\Desktop\Desktop\lukilme\college\pweb-angular\dist\pweb-angular"
    ...
    try {
        npx angular-cli-ghpages --dir=dist/pweb-angular
